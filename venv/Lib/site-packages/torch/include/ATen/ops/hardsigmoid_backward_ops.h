...
struct TORCH_API hardsigmoid_backward_grad_input {
  ...
  static constexpr const char* name = "aten::hardsigmoid_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "hardsigmoid_backward.grad_input(Tensor grad_output, Tensor self, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API hardsigmoid_backward {
  ...
  static constexpr const char* schema_str = "hardsigmoid_backward(Tensor grad_output, Tensor self) -> Tensor";
