...
struct TORCH_API smooth_l1_loss_backward_grad_input {
  ...
  static constexpr const char* name = "aten::smooth_l1_loss_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "smooth_l1_loss_backward.grad_input(Tensor grad_output, Tensor self, Tensor target, int reduction, float beta, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API smooth_l1_loss_backward {
  ...
  static constexpr const char* schema_str = "smooth_l1_loss_backward(Tensor grad_output, Tensor self, Tensor target, int reduction, float beta) -> Tensor";
