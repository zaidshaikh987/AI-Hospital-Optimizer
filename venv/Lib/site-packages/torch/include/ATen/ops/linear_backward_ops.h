...
struct TORCH_API linear_backward {
  ...
  static constexpr const char* name = "aten::linear_backward";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "linear_backward(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask) -> (Tensor, Tensor, Tensor)";
...
struct TORCH_API linear_backward_out {
  ...
  static constexpr const char* schema_str = "linear_backward.out(Tensor self, Tensor grad_output, Tensor weight, bool[3] output_mask, *, Tensor(a!) out0, Tensor(b!) out1, Tensor(c!) out2) -> (Tensor(a!), Tensor(b!), Tensor(c!))";
