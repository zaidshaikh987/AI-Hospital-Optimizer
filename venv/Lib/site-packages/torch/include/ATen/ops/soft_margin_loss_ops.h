...
struct TORCH_API soft_margin_loss_out {
  ...
  static constexpr const char* name = "aten::soft_margin_loss";
  static constexpr const char* overload_name = "out";
  static constexpr const char* schema_str = "soft_margin_loss.out(Tensor self, Tensor target, int reduction=Mean, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API soft_margin_loss {
  ...
  static constexpr const char* schema_str = "soft_margin_loss(Tensor self, Tensor target, int reduction=Mean) -> Tensor";
