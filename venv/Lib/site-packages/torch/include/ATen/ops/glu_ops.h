...
struct TORCH_API glu_out {
  ...
  static constexpr const char* name = "aten::glu";
  static constexpr const char* overload_name = "out";
  static constexpr const char* schema_str = "glu.out(Tensor self, int dim=-1, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API glu {
  ...
  static constexpr const char* schema_str = "glu(Tensor self, int dim=-1) -> Tensor";
