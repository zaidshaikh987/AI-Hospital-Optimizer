...
struct TORCH_API slow_conv3d_forward_output {
  ...
  static constexpr const char* name = "aten::slow_conv3d_forward";
  static constexpr const char* overload_name = "output";
  static constexpr const char* schema_str = "slow_conv3d_forward.output(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias, SymInt[3] stride, SymInt[3] padding, *, Tensor(a!) output) -> Tensor(a!)";
...
struct TORCH_API slow_conv3d_forward {
  ...
  static constexpr const char* schema_str = "slow_conv3d_forward(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias, SymInt[3] stride, SymInt[3] padding) -> Tensor";
