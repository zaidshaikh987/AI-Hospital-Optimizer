...
struct TORCH_API empty_quantized {
  ...
  static constexpr const char* name = "aten::empty_quantized";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "empty_quantized(int[] size, Tensor qtensor, *, ScalarType? dtype=None, Layout? layout=None, Device? device=None, bool? pin_memory=None, MemoryFormat? memory_format=None) -> Tensor";
...
struct TORCH_API empty_quantized_out {
  ...
  static constexpr const char* schema_str = "empty_quantized.out(int[] size, Tensor qtensor, *, MemoryFormat? memory_format=None, Tensor(a!) out) -> Tensor(a!)";
