...
struct TORCH_API special_softmax {
  ...
  static constexpr const char* name = "aten::special_softmax";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_softmax(Tensor self, int dim, ScalarType? dtype=None) -> Tensor";
