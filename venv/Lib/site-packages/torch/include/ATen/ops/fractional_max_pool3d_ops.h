...
struct TORCH_API fractional_max_pool3d_output {
  ...
  static constexpr const char* name = "aten::fractional_max_pool3d";
  static constexpr const char* overload_name = "output";
  static constexpr const char* schema_str = "fractional_max_pool3d.output(Tensor self, int[3] kernel_size, int[3] output_size, Tensor random_samples, *, Tensor(a!) output, Tensor(b!) indices) -> (Tensor(a!), Tensor(b!))";
...
struct TORCH_API fractional_max_pool3d {
  ...
  static constexpr const char* schema_str = "fractional_max_pool3d(Tensor self, int[3] kernel_size, int[3] output_size, Tensor random_samples) -> (Tensor, Tensor)";
