...
struct TORCH_API max_pool1d_with_indices {
  ...
  static constexpr const char* name = "aten::max_pool1d_with_indices";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "max_pool1d_with_indices(Tensor self, int[1] kernel_size, int[1] stride=[], int[1] padding=0, int[1] dilation=1, bool ceil_mode=False) -> (Tensor, Tensor)";
