...
struct TORCH_API feature_dropout {
  ...
  static constexpr const char* name = "aten::feature_dropout";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "feature_dropout(Tensor input, float p, bool train) -> Tensor";
...
struct TORCH_API feature_dropout_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::feature_dropout_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "feature_dropout_(Tensor(a!) self, float p, bool train) -> Tensor(a!)";
