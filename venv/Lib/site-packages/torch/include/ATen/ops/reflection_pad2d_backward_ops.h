...
struct TORCH_API reflection_pad2d_backward_grad_input {
  ...
  static constexpr const char* name = "aten::reflection_pad2d_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "reflection_pad2d_backward.grad_input(Tensor grad_output, Tensor self, SymInt[4] padding, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API reflection_pad2d_backward {
  ...
  static constexpr const char* schema_str = "reflection_pad2d_backward(Tensor grad_output, Tensor self, SymInt[4] padding) -> Tensor";
