...
struct TORCH_API fft_rfft2 {
  ...
  static constexpr const char* name = "aten::fft_rfft2";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "fft_rfft2(Tensor self, SymInt[1]? s=None, int[1] dim=[-2,-1], str? norm=None) -> Tensor";
...
struct TORCH_API fft_rfft2_out {
  ...
  static constexpr const char* schema_str = "fft_rfft2.out(Tensor self, SymInt[1]? s=None, int[1] dim=[-2,-1], str? norm=None, *, Tensor(a!) out) -> Tensor(a!)";
