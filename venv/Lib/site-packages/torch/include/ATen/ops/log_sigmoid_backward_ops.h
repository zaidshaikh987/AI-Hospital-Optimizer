...
struct TORCH_API log_sigmoid_backward_grad_input {
  ...
  static constexpr const char* name = "aten::log_sigmoid_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "log_sigmoid_backward.grad_input(Tensor grad_output, Tensor self, Tensor buffer, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API log_sigmoid_backward {
  ...
  static constexpr const char* schema_str = "log_sigmoid_backward(Tensor grad_output, Tensor self, Tensor buffer) -> Tensor";
