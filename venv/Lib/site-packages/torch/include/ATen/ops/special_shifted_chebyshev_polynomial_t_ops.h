...
struct TORCH_API special_shifted_chebyshev_polynomial_t {
  ...
  static constexpr const char* name = "aten::special_shifted_chebyshev_polynomial_t";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t(Tensor x, Tensor n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_t_x_scalar {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t.x_scalar(Scalar x, Tensor n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_t_n_scalar {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t.n_scalar(Tensor x, Scalar n) -> Tensor";
...
struct TORCH_API special_shifted_chebyshev_polynomial_t_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t.out(Tensor x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_shifted_chebyshev_polynomial_t_x_scalar_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t.x_scalar_out(Scalar x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_shifted_chebyshev_polynomial_t_n_scalar_out {
  ...
  static constexpr const char* schema_str = "special_shifted_chebyshev_polynomial_t.n_scalar_out(Tensor x, Scalar n, *, Tensor(a!) out) -> Tensor(a!)";
