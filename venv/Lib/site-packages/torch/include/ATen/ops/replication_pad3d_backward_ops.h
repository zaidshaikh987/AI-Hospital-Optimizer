...
struct TORCH_API replication_pad3d_backward_grad_input {
  ...
  static constexpr const char* name = "aten::replication_pad3d_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "replication_pad3d_backward.grad_input(Tensor grad_output, Tensor self, SymInt[6] padding, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API replication_pad3d_backward {
  ...
  static constexpr const char* schema_str = "replication_pad3d_backward(Tensor grad_output, Tensor self, SymInt[6] padding) -> Tensor";
