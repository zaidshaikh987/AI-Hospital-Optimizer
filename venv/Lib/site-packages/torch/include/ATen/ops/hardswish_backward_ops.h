...
struct TORCH_API hardswish_backward {
  ...
  static constexpr const char* name = "aten::hardswish_backward";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "hardswish_backward(Tensor grad_output, Tensor self) -> Tensor";
...
struct TORCH_API hardswish_backward_out {
  ...
  static constexpr const char* schema_str = "hardswish_backward.out(Tensor grad_output, Tensor self, *, Tensor(a!) out) -> Tensor(a!)";
