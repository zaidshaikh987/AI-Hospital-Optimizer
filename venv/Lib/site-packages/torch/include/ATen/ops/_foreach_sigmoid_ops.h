...
struct TORCH_API _foreach_sigmoid {
  ...
  static constexpr const char* name = "aten::_foreach_sigmoid";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_sigmoid(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_sigmoid_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_sigmoid_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_sigmoid_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_sigmoid_out {
  ...
  static constexpr const char* schema_str = "_foreach_sigmoid.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
