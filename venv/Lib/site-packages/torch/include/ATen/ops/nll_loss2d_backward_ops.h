...
struct TORCH_API nll_loss2d_backward_grad_input {
  ...
  static constexpr const char* name = "aten::nll_loss2d_backward";
  static constexpr const char* overload_name = "grad_input";
  static constexpr const char* schema_str = "nll_loss2d_backward.grad_input(Tensor grad_output, Tensor self, Tensor target, Tensor? weight, int reduction, SymInt ignore_index, Tensor total_weight, *, Tensor(a!) grad_input) -> Tensor(a!)";
...
struct TORCH_API nll_loss2d_backward {
  ...
  static constexpr const char* schema_str = "nll_loss2d_backward(Tensor grad_output, Tensor self, Tensor target, Tensor? weight, int reduction, SymInt ignore_index, Tensor total_weight) -> Tensor";
