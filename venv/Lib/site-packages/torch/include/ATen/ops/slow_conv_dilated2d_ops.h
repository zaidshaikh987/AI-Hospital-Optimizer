...
struct TORCH_API slow_conv_dilated2d {
  ...
  static constexpr const char* name = "aten::slow_conv_dilated2d";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "slow_conv_dilated2d(Tensor self, Tensor weight, SymInt[2] kernel_size, Tensor? bias=None, SymInt[2] stride=1, SymInt[2] padding=0, SymInt[2] dilation=1) -> Tensor";
...
struct TORCH_API slow_conv_dilated2d_out {
  ...
  static constexpr const char* schema_str = "slow_conv_dilated2d.out(Tensor self, Tensor weight, SymInt[2] kernel_size, Tensor? bias=None, SymInt[2] stride=1, SymInt[2] padding=0, SymInt[2] dilation=1, *, Tensor(a!) out) -> Tensor(a!)";
