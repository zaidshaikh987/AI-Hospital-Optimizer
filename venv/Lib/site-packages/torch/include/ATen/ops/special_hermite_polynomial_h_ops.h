...
struct TORCH_API special_hermite_polynomial_h {
  ...
  static constexpr const char* name = "aten::special_hermite_polynomial_h";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "special_hermite_polynomial_h(Tensor x, Tensor n) -> Tensor";
...
struct TORCH_API special_hermite_polynomial_h_x_scalar {
  ...
  static constexpr const char* schema_str = "special_hermite_polynomial_h.x_scalar(Scalar x, Tensor n) -> Tensor";
...
struct TORCH_API special_hermite_polynomial_h_n_scalar {
  ...
  static constexpr const char* schema_str = "special_hermite_polynomial_h.n_scalar(Tensor x, Scalar n) -> Tensor";
...
struct TORCH_API special_hermite_polynomial_h_out {
  ...
  static constexpr const char* schema_str = "special_hermite_polynomial_h.out(Tensor x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_hermite_polynomial_h_x_scalar_out {
  ...
  static constexpr const char* schema_str = "special_hermite_polynomial_h.x_scalar_out(Scalar x, Tensor n, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API special_hermite_polynomial_h_n_scalar_out {
  ...
  static constexpr const char* schema_str = "special_hermite_polynomial_h.n_scalar_out(Tensor x, Scalar n, *, Tensor(a!) out) -> Tensor(a!)";
