...
struct TORCH_API reflection_pad2d_out {
  ...
  static constexpr const char* name = "aten::reflection_pad2d";
  static constexpr const char* overload_name = "out";
  static constexpr const char* schema_str = "reflection_pad2d.out(Tensor self, SymInt[4] padding, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API reflection_pad2d {
  ...
  static constexpr const char* schema_str = "reflection_pad2d(Tensor self, SymInt[4] padding) -> Tensor";
