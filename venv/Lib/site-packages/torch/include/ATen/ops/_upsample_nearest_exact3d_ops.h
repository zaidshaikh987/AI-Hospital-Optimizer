...
struct TORCH_API _upsample_nearest_exact3d_vec {
  ...
  static constexpr const char* name = "aten::_upsample_nearest_exact3d";
  static constexpr const char* overload_name = "vec";
  static constexpr const char* schema_str = "_upsample_nearest_exact3d.vec(Tensor input, SymInt[]? output_size, float[]? scale_factors) -> Tensor";
...
struct TORCH_API _upsample_nearest_exact3d_out {
  ...
  static constexpr const char* schema_str = "_upsample_nearest_exact3d.out(Tensor self, SymInt[3] output_size, float? scales_d=None, float? scales_h=None, float? scales_w=None, *, Tensor(a!) out) -> Tensor(a!)";
...
struct TORCH_API _upsample_nearest_exact3d {
  ...
  static constexpr const char* schema_str = "_upsample_nearest_exact3d(Tensor self, SymInt[3] output_size, float? scales_d=None, float? scales_h=None, float? scales_w=None) -> Tensor";
