...
struct TORCH_API poisson {
  ...
  static constexpr const char* name = "aten::poisson";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "poisson(Tensor self, Generator? generator=None) -> Tensor";
...
struct TORCH_API poisson_out {
  ...
  static constexpr const char* schema_str = "poisson.out(Tensor self, Generator? generator=None, *, Tensor(a!) out) -> Tensor(a!)";
