...
struct TORCH_API _pad_enum {
  ...
  static constexpr const char* name = "aten::_pad_enum";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_pad_enum(Tensor self, SymInt[] pad, int mode, float? value=None) -> Tensor";
