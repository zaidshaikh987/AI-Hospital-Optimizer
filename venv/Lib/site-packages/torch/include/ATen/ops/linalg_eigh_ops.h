...
struct TORCH_API linalg_eigh {
  ...
  static constexpr const char* name = "aten::linalg_eigh";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "linalg_eigh(Tensor self, str UPLO=\"L\") -> (Tensor eigenvalues, Tensor eigenvectors)";
...
struct TORCH_API linalg_eigh_eigvals {
  ...
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::linalg_eigh";
  static constexpr const char* overload_name = "eigvals";
  static constexpr const char* schema_str = "linalg_eigh.eigvals(Tensor self, str UPLO=\"L\", *, Tensor(a!) eigvals, Tensor(b!) eigvecs) -> (Tensor(a!) eigenvalues, Tensor(b!) eigenvectors)";
