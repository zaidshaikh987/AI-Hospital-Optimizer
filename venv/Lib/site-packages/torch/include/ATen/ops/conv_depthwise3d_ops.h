...
struct TORCH_API conv_depthwise3d {
  ...
  static constexpr const char* name = "aten::conv_depthwise3d";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "conv_depthwise3d(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias, SymInt[3] stride, SymInt[3] padding, SymInt[3] dilation) -> Tensor";
...
struct TORCH_API conv_depthwise3d_out {
  ...
  static constexpr const char* schema_str = "conv_depthwise3d.out(Tensor self, Tensor weight, SymInt[3] kernel_size, Tensor? bias, SymInt[3] stride, SymInt[3] padding, SymInt[3] dilation, *, Tensor(a!) out) -> Tensor(a!)";
