...
struct TORCH_API _foreach_floor {
  ...
  static constexpr const char* name = "aten::_foreach_floor";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_floor(Tensor[] self) -> Tensor[]";
...
struct TORCH_API _foreach_floor_ {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_floor_";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_foreach_floor_(Tensor(a!)[] self) -> ()";
...
struct TORCH_API _foreach_floor_out {
  ...
  static constexpr const char* schema_str = "_foreach_floor.out(Tensor[] self, *, Tensor(a!)[] out) -> ()";
