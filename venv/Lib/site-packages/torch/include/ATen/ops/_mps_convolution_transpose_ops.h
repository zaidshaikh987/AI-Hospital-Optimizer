...
struct TORCH_API _mps_convolution_transpose {
  ...
  static constexpr const char* name = "aten::_mps_convolution_transpose";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "_mps_convolution_transpose(Tensor self, Tensor weight, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups) -> Tensor";
...
struct TORCH_API _mps_convolution_transpose_out {
  ...
  static constexpr const char* schema_str = "_mps_convolution_transpose.out(Tensor self, Tensor weight, SymInt[] padding, SymInt[] output_padding, SymInt[] stride, SymInt[] dilation, SymInt groups, *, Tensor(a!) out) -> Tensor(a!)";
