...
struct TORCH_API _foreach_addcdiv_Scalar {
  ...
  static constexpr const char* name = "aten::_foreach_addcdiv";
  static constexpr const char* overload_name = "Scalar";
  static constexpr const char* schema_str = "_foreach_addcdiv.Scalar(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar value=1) -> Tensor[]";
...
struct TORCH_API _foreach_addcdiv_ScalarList {
  ...
  static constexpr const char* schema_str = "_foreach_addcdiv.ScalarList(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar[] scalars) -> Tensor[]";
...
struct TORCH_API _foreach_addcdiv_Tensor {
  ...
  static constexpr const char* schema_str = "_foreach_addcdiv.Tensor(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Tensor scalars) -> Tensor[]";
...
struct TORCH_API _foreach_addcdiv__Scalar {
  ...
  using ptr_schema = schema*;
  // See Note [static constexpr char* members for windows NVCC]
  static constexpr const char* name = "aten::_foreach_addcdiv_";
  static constexpr const char* overload_name = "Scalar";
  static constexpr const char* schema_str = "_foreach_addcdiv_.Scalar(Tensor(a!)[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar value=1) -> ()";
...
struct TORCH_API _foreach_addcdiv__ScalarList {
  ...
  static constexpr const char* name = "aten::_foreach_addcdiv_";
  static constexpr const char* overload_name = "ScalarList";
  static constexpr const char* schema_str = "_foreach_addcdiv_.ScalarList(Tensor(a!)[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar[] scalars) -> ()";
...
struct TORCH_API _foreach_addcdiv__Tensor {
  ...
  static constexpr const char* name = "aten::_foreach_addcdiv_";
  static constexpr const char* overload_name = "Tensor";
  static constexpr const char* schema_str = "_foreach_addcdiv_.Tensor(Tensor(a!)[] self, Tensor[] tensor1, Tensor[] tensor2, Tensor scalars) -> ()";
...
struct TORCH_API _foreach_addcdiv_Scalar_out {
  ...
  static constexpr const char* schema_str = "_foreach_addcdiv.Scalar_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar value=1, *, Tensor(a!)[] out) -> ()";
...
struct TORCH_API _foreach_addcdiv_ScalarList_out {
  ...
  static constexpr const char* schema_str = "_foreach_addcdiv.ScalarList_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Scalar[] scalars, *, Tensor(a!)[] out) -> ()";
...
struct TORCH_API _foreach_addcdiv_Tensor_out {
  ...
  static constexpr const char* schema_str = "_foreach_addcdiv.Tensor_out(Tensor[] self, Tensor[] tensor1, Tensor[] tensor2, Tensor scalars, *, Tensor(a!)[] out) -> ()";
