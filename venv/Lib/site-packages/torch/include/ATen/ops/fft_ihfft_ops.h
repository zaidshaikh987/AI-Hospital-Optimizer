...
struct TORCH_API fft_ihfft {
  ...
  static constexpr const char* name = "aten::fft_ihfft";
  static constexpr const char* overload_name = "";
  static constexpr const char* schema_str = "fft_ihfft(Tensor self, SymInt? n=None, int dim=-1, str? norm=None) -> Tensor";
...
struct TORCH_API fft_ihfft_out {
  ...
  static constexpr const char* schema_str = "fft_ihfft.out(Tensor self, SymInt? n=None, int dim=-1, str? norm=None, *, Tensor(a!) out) -> Tensor(a!)";
